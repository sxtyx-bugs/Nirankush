  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        ...
        className={`${outfit.variable} ${manrope.variable} ${khand.variable} ${playfair.variable} ${almonde.variable} ${crossten.variable} ${authenticity.variable} ${demather.variable} ${palisade.variable} antialiased selection:bg-developer-accent/20 cursor-none`}
      >
